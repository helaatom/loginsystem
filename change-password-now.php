...
{
$userid=$_SESSION['id'];
$ret=mysqli_query($con,"update users set password='$newpassword', last_password_change=NOW() where id='$userid'");
...
echo "<script type='text/javascript'> document.location = 'change-password-now.php'; </script>";
}
}

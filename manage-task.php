                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="card mb-4">
                                ...
                                <table id="datatablesSimple">
                                  ...
                                  <th>Action</th>
                                    ...
                                    <tbody>
                                              <?php
                                              $id = $_SESSION['id'];
                                              $ret=mysqli_query($con,"select * from task WHERE user_id = $id");
                              $cnt=1;
                          ...
                          <i class="fas fa-edit"></i></a>
                                     <a href="manage-task.php?id=<?php echo $row['id'];?>" onClick="return confirm('Do you really want to delete');"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                  </td>
                              </tr>
                              <?php $cnt=$cnt+1; }?>
